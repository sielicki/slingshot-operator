...
import (
	...
	"github.com/sielicki/slingshot-operator/internal/controller"
	"github.com/sielicki/slingshot-operator/pkg/config"
	slingshotwebhook "github.com/sielicki/slingshot-operator/pkg/webhook"
...
func init() {
	...
	utilruntime.Must(cxiv1.AddToScheme(scheme))
...
func main() {
	...
	var enableSidecarWebhook bool
	var enableCXIDriverWebhook bool
	var retryHandlerImage string
	var tlsOpts []func(*tls.Config)
	flag.StringVar(&metricsAddr, "metrics-bind-address", config.GetEnv("METRICS_BIND_ADDRESS", "0"),
	...
	flag.BoolVar(&enableSidecarWebhook, "enable-sidecar-webhook", config.GetEnvBool("ENABLE_SIDECAR_WEBHOOK", false),
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "bf7f9b28.hpe.com",
	...
	if err := (&controller.CXIDriverReconciler{
		Client:    mgr.GetClient(),
		Scheme:    mgr.GetScheme(),
		Namespace: operatorNamespace,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "CXIDriver")
		os.Exit(1)
	}

	if enableSidecarWebhook || enableCXIDriverWebhook {
		setupLog.Info("Setting up webhooks",
			"sidecarInjector", enableSidecarWebhook,
			"cxiDriverValidator", enableCXIDriverWebhook)
		if err := slingshotwebhook.SetupWithManager(mgr, slingshotwebhook.WebhookConfig{
			EnableSidecarInjector:  enableSidecarWebhook,
			EnableCXIDriverWebhook: enableCXIDriverWebhook,
			SidecarInjector: slingshotwebhook.SidecarInjectorConfig{
				RetryHandlerImage: retryHandlerImage,
			},
		}); err != nil {
